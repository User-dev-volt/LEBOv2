...
- [x] [Review][Defer] Delta direction is conveyed by ▲/▼ glyph + color only, no text alternative — screen readers get an ambiguous "▲ 2.0" (numeric value still read) [lebo/src/features/optimization/ScoreGauge.tsx:123] — deferred, minor a11y enhancement
