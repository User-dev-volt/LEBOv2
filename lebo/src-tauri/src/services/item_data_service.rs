...
mod tests {
    ...
    fn shipped_item_db_carries_level_and_display_text() {
        ...
        // AC1 — pin a non-zero UNIQUE level. Calamity is legitimately level 0, so a uniques-only
